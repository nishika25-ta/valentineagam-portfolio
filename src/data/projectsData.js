export const projectsData = [
  {
    ...
    shortTitle: 'AI/ML Palm Tree Detection',
    category: 'AI/Machine Learning',
    keywords: ['Python', 'AI', 'Machine Learning', 'YOLO', 'Automation'],
    description: 'Deep learning system for automated agricultural monitoring.',
    fullDescription: `
    ...
    `,
    image: '/images/icons/palms.png',
    images: [
      '/images/contents/palms/vale_poster.jpg',
      '/images/contents/palms/FullStack.jpg',
      '/images/contents/palms/Poster.jpg',
      '/images/contents/palms/Detection.jpg'
    ]
  },
  {
    id: 'modal-2',
    title: 'Ultra Dim - Super Dimmer APK',
    shortTitle: 'Ultra Dim',
    category: 'Mobile Development',
    keywords: ['Flutter', 'Mobile Development', 'Android', 'UI/UX'],
    description: 'Flutter app for enhanced night driving safety.',
    fullDescription: `
  ...
  },
  {
    ...
    `,
    image: '/images/icons/trombol_logo.jpeg',
    images: [
      '/images/contents/trombol/Trombol_Main_Page.jpg',
      '/images/contents/trombol/Trombol_signin.jpg'
    ],
  },
  {
    id: 'modal-4',
    title: 'UNIMAS AR Navigator App',
    shortTitle: 'UNIMAS AR Navigator',
    category: 'Augmented Reality',
    keywords: ['Flutter', 'Augmented Reality', 'WebAR', 'Mobile Development'],
    description: 'Augmented reality campus navigation solution.',
    fullDescription: `
    ...
    `,
    image: '/images/icons/ar_app_icon.jpeg',
    images: [
      '/images/contents/ar/UNIMAS_AR_mainpage.jpg',
      '/images/contents/ar/Unimas_AR.jpg'
    ],
  },
  {
    id: 'modal-5',
    title: 'Global Connection System',
    shortTitle: 'Global Connection System',
    category: 'Mobile Development',
    keywords: ['Mobile Development', 'UI/UX Design', 'Community Empowerment', 'Local Tourism'],
    description: 'Mobile app for community empowerment and local tourism.',
    fullDescription: `
    ...
    `,
    image: '/images/icons/gsc.jpeg',
    images: [
      '/images/contents/global/gsc2.png',
      '/images/contents/global/gsc1.png',
      '/images/contents/global/gsc3.png'
    ],
  },
  {
    id: 'modal-6',
    title: 'Personal Finance Management App',
    shortTitle: 'Personal Finance App',
    category: 'FinTech',
    keywords: ['UI/UX Design', 'Mobile App', 'FinTech', 'Data Visualization'],
    description: 'Mobile app for expense tracking, budgeting, and savings.',
    fullDescription: `
    ...
    `,
    image: '/images/icons/fma.jpeg',
    images: [
      '/images/contents/fma/login.png',
      '/images/contents/fma/dashboard.png',
      '/images/contents/fma/invest.png',
      '/images/contents/fma/motivation.png'
    ],
  },
  {
    id: 'modal-7',
    title: 'Project: Bookabary',
    shortTitle: 'Bookabary',
    category: 'Full-Stack',
    keywords: ['Flutter', 'Supabase', 'PostgreSQL', 'Full-Stack', 'Google Books API', 'TMDB API', 'UI/UX'],
    description: 'Full-stack app to scan, track, and organize ebooks and movies.',
    fullDescription: `
    ...
    `,
    image: '/images/icons/bookabary.jpeg',
    images: [
      '/images/contents/bookabary1.png',
      '/images/contents/bookabary2.png',
      '/images/contents/bookabary3.png'
    ],
  },
  {
    id: 'modal-ongoing-1',
    title: 'XAI-PE Analyzer: Explainable Malware Detection',
    shortTitle: 'XAI-PE Analyzer',
    category: 'Machine Learning',
    keywords: ['Python', 'XGBoost', 'SHAP', 'Malware Analysis', 'XAI'],
    description: 'Explainable AI tool for static Windows PE malware detection.',
    fullDescription: `
    ...
    `,
    image: '/images/icons/xai.png',
    images: [
      '/images/contents/XAI.png'
    ]
  },
  {
    id: 'modal-8',
    ...
    keywords: ['Python', 'Flask', 'React', 'Electron', 'Groq AI', 'Speech Recognition'],
    description: 'Real-time AI meeting assistant with live audio transcription and intelligent responses.',
    fullDescription: `
      <h3>🎙️ Darklace AI Meeting Assistant</h3>
      <p>A full-stack AI-powered meeting assistant that provides real-time audio transcription and intelligent AI responses during meetings and presentations.</p>
      <h4>The Challenge & Goal</h4>
      <p>The objective was to create a seamless, overlay-based assistant that can listen to meeting audio, transcribe it in real-time, and provide contextual AI assistance without disrupting the meeting flow.</p>
      <h4>The Solution</h4>
      <p>Built a multi-component solution featuring a Python/Flask backend for audio processing and AI integration, a React frontend for the user interface, and an Electron overlay for always-on-top functionality during meetings.</p>
      <h4>Key Features</h4>
      <ul>
        <li><strong>Live Audio Transcription:</strong> Real-time speech-to-text using Google Speech Recognition for accurate meeting transcription.</li>
        <li><strong>AI-Powered Responses:</strong> Integration with Groq AI for intelligent, contextual responses to meeting discussions.</li>
        <li><strong>Electron Overlay:</strong> Non-intrusive floating interface that stays accessible during any application.</li>
        <li><strong>Cross-Platform:</strong> Built with technologies that support Windows deployment with potential for multi-platform expansion.</li>
      </ul>
    `,
    image: '/images/contents/DARKLACE_logo.jpeg',
    images: [
      '/images/contents/Darklace.png'
    ]
  }
];
